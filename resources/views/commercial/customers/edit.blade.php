        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                ...
                <h2 class="text-2xl font-bold leading-7 text-slate-900 sm:text-3xl">
                    <i class="fa-solid fa-user-pen mr-3 text-blue-600"></i>
                    Editar Cliente
                </h2>
                <p class="mt-1 text-sm text-slate-500">
                    Actualiza la información del cliente. Los cambios en RFC/CURP se reflejarán encriptados.
                </p>
            </div>

            <!-- Formulario -->
            <form action="{{ route('inventory.commercial.customers.update', $customer) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                    ...
                    <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="type" id="type" required 
                                ...
                                <option value="persona_fisica" {{ old('type', $customer->type) === 'persona_fisica' ? 'selected' : '' }}>Persona Física</option>
                                <option value="persona_moral" {{ old('type', $customer->type) === 'persona_moral' ? 'selected' : '' }}>Empresa</option>
                            </select>
                            @error('type')
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   name="ine_url" 
                                   id="ine_url" 
                                   value="{{ old('ine_url', $customer->ine_url) }}" 
                                   maxlength="500"
                                   placeholder="https://..."
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('proof_of_address_url', $customer->proof_of_address_url) }}" 
                                   maxlength="500"
                                   placeholder="https://..."
                        ...
                        <div>
                            ...
                            <textarea name="notes" 
                                      ...
                                      class="w-full rounded-lg border-slate-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 @error('notes') border-red-500 @enderror">{{ old('notes', $customer->notes) }}</textarea>
                            @error('notes')
                                <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
